...
function [R,A,T,grid,fluence,heating] = scatter_simulation_mus(num_photons,beam_type,R_0,mu_s)
...
%                    event
 ...
 mu_a = 2.15;    % absorption coefficient [cm^-1]
% mu_s = 14.20;     % scattering coefficient [cm^-1]
